...
parser.add_argument('--input_dir', type=str, default='C://users//davide//desktop//desk',
                    help='directory for input images (unresized images)')

parser.add_argument('--output_dir', type=str, default='C://users//davide//desktop//train2014resized',
